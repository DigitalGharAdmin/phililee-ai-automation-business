# Customer Support configuration reference

See the [project overview](../README.md) for setup and offline tests.
PostgreSQL and authenticated manual checks below are opt-in, not offline validation.
...
See [deployment guidance](deployment.md) for the production configuration contract, migration order,
