...
| status | rejected, conflict, logged, awaiting_approval, completed, duplicate, failed, needs_reconciliation |
| logged | boolean; true if a durable CRM record exists |
| email_status | not_requested, disabled, pending_approval, sending, sent, failed, unknown |
| result_summary | fixed enum: invalid_input, id_conflict, recorded, approval_required, acknowledgement_sent, existing_request, operation_failed, reconciliation_required |
